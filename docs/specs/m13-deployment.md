...
| T10 | Rollback **rehearsed**; production load baseline (M12 handover) — **partly rehearsed against development; §3 was found wrong. §2 and the load baseline still need an environment** |
