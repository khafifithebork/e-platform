...
def transcript_factory(db):
    ...
    Local to this file rather than in conftest: a transcript needs a language,
    an instructor, a course, a section, a lesson and a media asset behind it,
    and building that chain once here is clearer than a shared factory nothing
    else asks for yet.
    """
